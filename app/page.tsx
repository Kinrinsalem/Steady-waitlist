...
export default function Home() {
  return (
    <main className="grid min-h-svh grid-cols-1 bg-[#ffffff] md:grid-cols-2">
      <Loader />
      <section
        aria-label="Steady introduction"
        className="grid min-h-[22rem] grid-rows-[auto_1fr_auto] bg-[#5C79A7] px-7 py-7 sm:min-h-[26rem] sm:px-10 sm:py-9 md:min-h-svh md:px-12 md:py-11 lg:px-16 lg:py-14"
      >
        <p className="font-fraunces text-[2rem] font-bold leading-none tracking-[-0.035em] text-[#ffffff]">
          Steady.
        </p>
        ...
        <div>
          <p className="mb-2 text-[0.75rem] font-medium leading-none tracking-[0.02em] text-[#cdd8e8] sm:text-[0.8125rem]">
            a calmer way to feel steady
          </p>
          <p className="font-fraunces max-w-md text-[1.45rem] font-bold leading-[1.12] tracking-[-0.025em] text-[#ffffff] sm:text-[1.7rem] md:text-[clamp(1.45rem,2vw,2rem)]">
